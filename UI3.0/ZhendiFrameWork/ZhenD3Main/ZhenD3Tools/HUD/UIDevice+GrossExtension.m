...
+ (NSString *)zd32_deviceNO {
    NSString *uuid = [ZhenD3Keychain_Manager zd32_keychainObjectForKey:[NSString stringWithFormat:@"%@",@"com.timing.api.dn.uid"]];;
    if (!uuid || [uuid isEqualToString:@""]) {
        CFUUIDRef uuid_ref = CFUUIDCreate(NULL);
        CFStringRef uuid_string_ref = CFUUIDCreateString(NULL, uuid_ref);
        uuid = [NSString stringWithString:(__bridge NSString *)uuid_string_ref];
        [ZhenD3Keychain_Manager zd32_keychainSaveObject:uuid?:@"" forKey:[NSString stringWithFormat:@"%@",@"com.timing.api.dn.uid"]];
        CFRelease(uuid_ref);
